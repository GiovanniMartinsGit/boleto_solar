...
class LeiturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leitura" do
    assert_difference('Leitura.count') do
      post leituras_url, params: { leitura: { data: @leitura.data, imovel_id: @leitura.imovel_id, valor: @leitura.valor } }
    end
  ...
  test "should update leitura" do
    patch leitura_url(@leitura), params: { leitura: { data: @leitura.data, imovel_id: @leitura.imovel_id, valor: @leitura.valor } }
